...
# ===========================================================================
HOST = "rajbir"   # shown as  rajbir@github  in the header

ROWS = [
    ("host",),
    ("kv", "Title", "B.Tech CSE (AI & ML)"),
    ("kv", "Status", "Full-Stack Developer in Progress"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C++, JavaScript"),
    ("kv", "Frontend", "React, HTML, CSS"),
    ("kv", "Backend", "Node.js, Express"),
    ("kv", "Tools", "Git"),
    ("gap",),
    ("sec", "Currently Learning"),
    ("bul", "MongoDB & REST APIs"),
    ("bul", "Data Structures & Algorithms"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "Employee Management API"),
    ("bul", "React UI Clone"),
]
